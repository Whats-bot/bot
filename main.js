...
conn.bye = '*╔══════════════*\n*╟❧ @user*\n*╟❧ Нас покинул предатель 👋🏻\n\n Таким здесь не место)))*\n\n Ну и в догонку фирменный пинок от Джокера))) \n*╚══════════════*'
conn.spromote = '*@user Назначен администратором группы*'
conn.sdemote = '*@user снят с должности Администратор !!*'
