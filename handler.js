...
global.dfail = (type, m, conn) => {
    let msg = {
        ...
        owner: '*[ ⚠️ 𝐀𝐋𝐄𝐑𝐓𝐀 ⚠️ ] ЭТА КОМАНДА ТОЛЬКО ДЛЯ МОЕГО СОЗДАТЕЛЯ*',
        mods: '*[ ⚠️ 𝐀𝐋𝐄𝐑𝐓𝐀 ⚠️ ] ЭТА КОМАНДА ТОЛЬКО ДЛЯ АДМИНИСТРАТОРОВ!ОБРАТИТЕСЬ К МОЕМУ СОЗДАТЕЛЮ ДЛЯ РЕШЕНИЯ ПРОБЛЕМЫ*',
        premium: '*[ ⚠️ 𝐀𝐋𝐄𝐑𝐓𝐀 ⚠️ ] ЭТА КОМАНДА ТОЛЬКО ДЛЯ ПРЕМИУМ ПОЛЬЗОВАТЕЛЕЙ!ОБРАТИТЕСЬ К МОЕМУ СОЗДАТЕЛЮ ДЛЯ РЕШЕНИЯ ПРОБЛЕМЫ*',
        group: '*[ ⚠️ 𝐀𝐋𝐄𝐑𝐓𝐀 ⚠️ ] ЭТА КОМАНДА ТОЛЬКО ДЛЯ ИСПОЛЬЗОВАНИЯ В ГРУППЕ*',
        private: '*[ ⚠️ 𝐀𝐋𝐄𝐑𝐓𝐀 ⚠️ ] ЭТА КОМАНДА ТОЛЬКО ДЛЯ ЛИЧКИ*',
        admin: '*[ ⚠️ 𝐀𝐋𝐄𝐑𝐓𝐀 ⚠️ ] ЭТА КОМАНДА ТОЛЬКО ДЛЯ АДМИНИСТРАТОРОВ ГРУППЫ!ОБРАТИТЕСЬ К МОЕМУ СОЗДАТЕЛЮ ДЛЯ РЕШЕНИЯ ПРОБЛЕМЫ*',
        botAdmin: '*[ ⚠️ 𝐀𝐋𝐄𝐑𝐓𝐀 ⚠️ ] ВЫ ОФИГЕЛИ?КАК Я ВЫПОЛНЮ ЭТУ КОМАНДУ ЕСЛИ Я НЕ АДМИН?бЫСТРО АДМИНКУ МНЕ!*',
        unreg: '*[ 🛑 ПРИВЕТ!нЕЗАРЕГЕСТРИРОВАННЫЙ ПОЛЬЗОВАТЕЛЬ) 🛑 ]*\n\n*—◉ Зарегайся в моей системе и будет все ништяк)))Для регистрации введи команду*\n*➣ #verificar*',
        restrict: '*[ ⚠️ 𝐀𝐋𝐄𝐑𝐓𝐀 ⚠️ ] Че лезешь куда не просят?Эта команда только для моего создателя)*'
    }[type]
