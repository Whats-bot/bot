...
export async function participantsUpdate({ id, participants, action }) {
    ...
    switch (action) {
                ...
                for (let user of participants) {
                    ...
                    try {
                        ...
                        text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc?.toString() || '*𝚂𝙸𝙽 𝙳𝙴𝚂𝙲𝚁𝙸𝙿𝙲𝙸𝙾𝙽*') :
                            ...
                            [(action == 'add' ? 'Добро пожаловать' : 'Пока'), 'ura'],    
                            ['Не нажимать', '/']
                            ], '', { mentions: [user]})
                           }
                    }
        ...
        case 'daradmin':
        case 'датьадмина':
            text = (chat.sPromote || this.spromote || conn.spromote || '@user Назначен администратором группы```')
        case 'demote':
        case 'quitarpoder':
        case 'снятьадмина':
            if (!text)
                text = (chat.sDemote || this.sdemote || conn.sdemote || '@user Больше не является администратором группы```')
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: '*[ ⚠️ ВНИМАНИЕ ⚠️ ] КОМАНДА ТОЛЬКО ДЛЯ ВАДЕЛЬЦА.Обратитесь к моему хозяину))*',
        owner: '*[ ⚠️ ВНИМАНИЕ ⚠️ ] КОМАНДА ТОЛЬКО ДЛЯ ВАДЕЛЬЦА.Обратитесь к моему хозяину))*',
        mods: '*[ ⚠️ ВНИМАНИЕ ⚠️ ] 𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾𝙻𝙾 𝙿𝚄𝙴𝙳𝙴 𝚂𝙴𝚁 𝚄𝚃𝙸𝙻𝙸𝚉𝙰𝙳𝙾 𝙿𝙾𝚁 𝙼𝙾𝙳𝙴𝚁𝙰𝙳𝙾𝚁𝙴𝚂 𝚈 𝙴𝙻/𝙻𝙰 𝙿𝚁𝙾𝙿𝙸𝙴𝚃𝙰𝚁𝙸𝙾/𝙰 (𝙾𝚆𝙽𝙴𝚁) 𝙳𝙴𝙻 𝙱𝙾𝚃*',
        premium: '*[ ⚠️ ВНИМАНИЕ ⚠️ ] КОМАНДА ТОЛЬКО ДЛЯ ПРЕМИУМ ПОЛЬЗОВАТЕЛЯ.Обратитесь к моему хозяину))*',
        group: '*[ ⚠️ ВНИМАНИЕ ⚠️ ] КОМАНДА ТОЛЬКО ДЛЯ АДМИНИСТРАТОРОВ ГРУППЫ.*',
        private: '*[ ⚠️ ВНИМАНИЕ ⚠️ ] 𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾𝙻𝙾 𝙿𝚄𝙴𝙳𝙴 𝚂𝙴𝚁 𝚄𝚃𝙸𝙻𝙸𝚉𝙰𝙳𝙾 𝙴𝙽 𝙲𝙷𝙰𝚃 𝙿𝚁𝙸𝚅𝙰𝙳𝙾 𝙳𝙴𝙻 𝙱𝙾𝚃*',
        admin: '*[ ⚠️ ВНИМАНИЕ ⚠️ ] КОМАНДА ТОЛЬКО ДЛЯ АДМИНИСТРАТОРОВ ГРУППЫ.*',
        botAdmin: '*[ ⚠️ ВНИМАНИЕ ⚠️ ] ЧТО БЫ Я ВЫПОЛНИЛ КОМАНДУ ДАЙТЕ МНЕ АДМИНКУ*',
        unreg: '*[ 🛑 Привет!! К сожалению ты не зарегестрирован в моей системе 🛑 ]*\n\n*—◉ Что бы пройти регистрацию введи команду*\n*➣ #verificar*',
        restrict: '*[ ⚠️ ВНИМАНИЕ ⚠️ ] КОМАНДА ТОЛЬКО ДЛЯ ВАДЕЛЬЦА.Обратитесь к моему хозяину))'
    }[type]
