...
*■ Ниже ваше удаленное сообщение!*
*■ Для отключения или включения функции,введите команду:*
*—◉ #отключить антиудаление *
*—◉ #включить антиудаление*
━━━━⬣  Антиудаление сообщений  ⬣━━━━
`.trim(), msg, {
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: '*[ ⚠️ ВНИМАНИЕ ⚠️ ] ЭТА КОМАНДА ТОЛЬКО ДЛЯ МОЕГО СОЗДАТЕЛЯ*',
        owner: '*[ ⚠️ ВНИМАНИЕ ⚠️ ] ЭТА КОМАНДА ТОЛЬКО ДЛЯ МОЕГО СОЗДАТЕЛЯ*',
        mods: '*[ ⚠️ ВНИМАНИЕ ⚠️ ] ЭТА КОМАНДА ТОЛЬКО ДЛЯ АДМИНИСТРАТОРОВ!ОБРАТИТЕСЬ К МОЕМУ СОЗДАТЕЛЮ ДЛЯ РЕШЕНИЯ ПРОБЛЕМЫ*',
        premium: '*[ ⚠️ ВНИМАНИЕ ⚠️ ] ЭТА КОМАНДА ТОЛЬКО ДЛЯ ПРЕМИУМ ПОЛЬЗОВАТЕЛЕЙ!ОБРАТИТЕСЬ К МОЕМУ СОЗДАТЕЛЮ ДЛЯ РЕШЕНИЯ ПРОБЛЕМЫ*',
        group: '*[ ⚠️ ВНИМАНИЕ ⚠️ ] ЭТА КОМАНДА ТОЛЬКО ДЛЯ ИСПОЛЬЗОВАНИЯ В ГРУППЕ*',
        private: '*[ ⚠️ ВНИМАНИЕ ⚠️ ] ЭТА КОМАНДА ТОЛЬКО ДЛЯ ЛИЧКИ*',
        admin: '*[ ⚠️ ВНИМАНИЕ ⚠️ ] ЭТА КОМАНДА ТОЛЬКО ДЛЯ АДМИНИСТРАТОРОВ ГРУППЫ!ОБРАТИТЕСЬ К МОЕМУ СОЗДАТЕЛЮ ДЛЯ РЕШЕНИЯ ПРОБЛЕМЫ*',
        botAdmin: '*[ ⚠️ ВНИМАНИЕ ⚠️ ] ВЫ ОФИГЕЛИ?КАК Я ВЫПОЛНЮ ЭТУ КОМАНДУ ЕСЛИ Я НЕ АДМИН?бЫСТРО АДМИНКУ МНЕ!*',
        unreg: '*[ 🛑 ПРИВЕТ!НЕЗАРЕГЕСТРИРОВАННЫЙ ПОЛЬЗОВАТЕЛЬ) 🛑 ]*\n\n*—◉ Зарегайся в моей системе и будет все ништяк)))Для регистрации введи команду*\n*➣ #регистрация*',
        restrict: '*[ ⚠️ ВНИМАНИЕ ⚠️ ] Че лезешь куда не просят?Эта команда только для моего создателя)*'
    }[type]
