...
let str = `
*ミ💖 Привет ✨${name}✨, Я Джокер)Ниже представлен список моих комманд 💖彡*

*📅 Время: ${week}, ${date}*
*📈 Дата: ${uptime}*
*📊 Зарагестрировано: ${rtotalreg}*
...
° ඬ⃟💎 _${usedPrefix}назначитьадмином *<@номер>*_
° ඬ⃟💎 _${usedPrefix}demote *<@tag>*_
° ඬ⃟💎 _админы *<ваш текст>*_ (использовать в экстренных ситуациях)
...
° ඬ⃟👽 _${usedPrefix}стикер *<выделите изображение/гиф/видео>*_
° ඬ⃟👽 _${usedPrefix}стикер *<ссылка на изображение/гиф/видео>*_
° ඬ⃟👽 _${usedPrefix}с *<выделите изображение/гиф/видео>*_
° ඬ⃟👽 _${usedPrefix}с *<ссылка на изображение/гиф/видео>*_
° ඬ⃟👽 _${usedPrefix}смайлмикс *<смайл 1>&<смайл 2>*_
...
° ඬ⃟👽 _${usedPrefix}поцелуй *<@участник>*_
° ඬ⃟👽 _${usedPrefix}кубики_
...
`.trim()
conn.sendHydrated2(m.chat, str, wm, pp, 'ФОРМИРУЕТСЯ ПЛАТЕЖНАЯ ССЫЛКА', 'ДОНАТ', 'https://wa.me/79524197466', 'ВЛАДЕЛЕЦ', [
